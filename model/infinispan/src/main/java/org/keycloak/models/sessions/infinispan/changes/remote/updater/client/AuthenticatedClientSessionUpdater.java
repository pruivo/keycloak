...
public class AuthenticatedClientSessionUpdater extends BaseUpdater<UUID, AuthenticatedClientSessionEntity> implements AuthenticatedClientSessionModel {
    ...
    public String getCurrentRefreshToken() {
        return getValue().getCurrentRefreshToken();
    }

    @Override
    public void setCurrentRefreshToken(String currentRefreshToken) {
        addAndApplyChange(entity -> entity.setCurrentRefreshToken(currentRefreshToken));
    }

    @Override
    public int getCurrentRefreshTokenUseCount() {
        return getValue().getCurrentRefreshTokenUseCount();
    }

    @Override
    public void setCurrentRefreshTokenUseCount(int currentRefreshTokenUseCount) {
        addAndApplyChange(entity -> entity.setCurrentRefreshTokenUseCount(currentRefreshTokenUseCount));
    }
