...
public class RemoteUserSessionProvider implements UserSessionProvider {
    ...
    public void removeUserSessions(RealmModel realm) {
        //although not documented, it only removes the online sessions
    ...
    private UserSessionUpdater initFromStream(UserSessionUpdater updater, RealmModel realm, UserModel user, boolean offline) {
        if (updater.isInitialized()) {
            return updater;
        }
        assert realm != null;
